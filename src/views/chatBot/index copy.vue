<template>
  <div class="chat-home">
    ...
    <el-header height="60px" class="nav-bar">
      <span>医知立方 MediQube</span>
      <el-button type="text" icon="el-icon-menu" @click="showHistory = true" style="float:right;">历史会话</el-button>
    </el-header>

    <!-- 聊天内容区 -->
    <el-main class="chat-content" ref="chatContent">
      <div v-if="welcomeShow" class="welcome-box">
        <img :src="robotAvatar || '/images/logo.png'" class="welcome-img" />
      ...
      <div v-for="(item, index) in msgList" :key="index" :id="'msg-' + index" class="msg-row">
        ...
        <div v-if="item.speaker === 'server'" class="msg-left">
          <img :src="robotAvatar || '/images/chatLogo.png'" class="avatar" />
